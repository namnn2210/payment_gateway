...
class Payout(models.Model):
    ...
    bankcode = models.CharField(max_length=255, default='')
    partner_bankcode = models.CharField(max_length=10, default='')
    is_auto = models.BooleanField(default=False)
    is_cancel = models.BooleanField(default=False)
    is_report = models.BooleanField(default=False)
    process_bank = models.ForeignKey(Bank, on_delete=models.CASCADE, default='')
    status = models.BooleanField(default=False,null=True)
    updated_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name='payout_created_by', default=1)
