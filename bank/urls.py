...
from .views import list_bank, AddBankView, update_transaction_history, update_balance, record_book, toggle_bank_status,toggle_transaction_status, get_amount_today,export_to_excel
...
urlpatterns = [
    ...
    path('toggle_transaction_status/', toggle_transaction_status, name='toggle_transaction_status'),
